namespace MetroidvaniaItems.Behaviours
{
    ...
    public class BehaviourDoubleJump : IBlockBehaviour
    {
        ...
        public bool ExecuteBlockBehaviour(BehaviourContext behaviourContext)
        {
            ...
            if (ModEntry.DataMetroidvania.Active == ModItems.DoubleJump && this.Player.m_body.IsOnGround)
            {
                this.DoubleJumpFlag = true;
                this.DoubleJumpVelocity = 0f;
            }
            else if (ModEntry.DataMetroidvania.Active != ModItems.DoubleJump && this.Player.m_body.IsOnGround)
            {
